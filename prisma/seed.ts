...
async function main() {
  if (process.env.NODE_ENV === 'production' && process.env.ALLOW_PROD_SEED !== 'true') {
    throw new Error(
      'Refusing to run prisma/seed.ts against a production database (it deletes existing ' +
      'CaseStudy/ServiceItem/ServiceCategory rows first). Set ALLOW_PROD_SEED=true to override.',
    );
  }
  ...
  await prisma.serviceItem.createMany({
    data: [
      ...
      },
      {
        ...
        descEn: 'Stunning responsive web applications built with next-gen frameworks (Next.js, Three.js, Prisma, Tailwind).',
        descBn: 'নেক্সট-জেন ফ্রেমওয়ার্ক (Next.js, Three.js, Prisma, Tailwind) দিয়ে তৈরি চমৎকার রেসপন্সিভ ওয়েব অ্যাপ্লিকেশন।',
        icon: 'Zap',
        theme: 'cyan',
        order: 1,
      },
  ...
  // NOTE: these are illustrative placeholder case studies (no invented client names or
  // fabricated metrics) pending real, client-approved case studies to replace them.
  await prisma.caseStudy.create({
    data: {
      titleEn: 'Enterprise AI Transformation',
      titleBn: 'এন্টারপ্রাইজ এআই রূপান্তর',
      clientEn: 'A Global Financial Services Firm',
      clientBn: 'একটি বৈশ্বিক আর্থিক সেবা প্রতিষ্ঠান',
      categoryId: 'it',
      ...
      metricsEn: 'Meaningful Efficiency Gains',
      metricsBn: 'উল্লেখযোগ্য দক্ষতা বৃদ্ধি',
      challengeEn: 'The client was operating with highly fragmented analog data structures, causing significant pipeline latency and workflow backlogs.',
      challengeBn: 'প্রতিষ্ঠানটি অত্যন্ত খণ্ডিত অ্যানালগ ডেটা কাঠামোর মাধ্যমে কাজ করছিল, যার ফলে গুরুতর কর্মপ্রবাহ ব্যাকলগ তৈরি হচ্ছিল।',
      ...
      solutionBn: 'আমরা কমপ্লায়েন্স অডিটিং, রিয়েল-টাইম রাউটিং বিশ্লেষণ এবং শিপিং মূল্যায়ন স্বয়ংক্রিয় করতে Next.js মাইক্রোসার্ভিস এবং কাস্টম এলএলএম এজেন্টের সমন্বয়ে একটি ক্লাউড পাইপলাইন তৈরি করেছি।',
  ...
  await prisma.caseStudy.create({
    data: {
      titleEn: 'Operational Process Re-Engineering',
      titleBn: 'অপারেশনাল প্রসেস রি-ইঞ্জিনিয়ারিং',
      clientEn: 'A Multinational Energy Provider',
      clientBn: 'একটি বহুজাতিক জ্বালানি প্রতিষ্ঠান',
      categoryId: 'consultancy',
      ...
      metricsEn: 'Significant Efficiency Gains',
      metricsBn: 'উল্লেখযোগ্য দক্ষতা বৃদ্ধি',
      challengeEn: 'Friction between global refining nodes caused supply delivery bottlenecks and lost opportunities.',
      challengeBn: 'বৈশ্বিক রিফাইনিং নোডগুলির মধ্যে ঘর্ষণের কারণে সরবরাহে বাধা সৃষ্টি হচ্ছিল এবং সুযোগ নষ্ট হচ্ছিল।',
  ...
  await prisma.caseStudy.create({
    data: {
      titleEn: 'Global Compliance Restructuring',
      titleBn: 'গ্লোবাল কমপ্লায়েন্স পুনর্গঠন',
      clientEn: 'A Regional Banking Group',
      clientBn: 'একটি আঞ্চলিক ব্যাংকিং গ্রুপ',
      categoryId: 'legal',
      ...
      metricsEn: 'Fully Compliant Audit Outcomes',
      metricsBn: 'সম্পূর্ণ সম্মতিপূর্ণ অডিট ফলাফল',
      challengeEn: 'Cross-border regulations and multi-jurisdictional audits threatened banking licenses across several sovereign states.',
      challengeBn: 'সীমান্তবর্তী নিয়মাবলী এবং বহু-অধিক্ষেত্রের অডিট একাধিক সার্বভৌম দেশে ব্যাংকিং লাইসেন্সকে হুমকির মুখে ফেলেছিল।',
  ...
  await prisma.caseStudy.create({
    data: {
      titleEn: 'Immersive 3D Visual Rollout',
      titleBn: 'ইমারসিভ 3D ভিজ্যুয়াল রোলআউট',
      clientEn: 'A National Retail Brand',
      clientBn: 'একটি জাতীয় খুচরা ব্র্যান্ড',
      categoryId: 'creative',
      ...
      metricsEn: 'Significant Engagement Growth',
      metricsBn: 'উল্লেখযোগ্য ব্যস্ততা বৃদ্ধি',
      ...
      solutionBn: 'ইন্টারেক্টিভ 3D WebGL শোকেস প্ল্যাটফর্ম তৈরি করা হয়েছে এবং আধুনিক ভিজ্যুয়াল আইডেন্টিটি সিস্টেম রোলআউট করা হয়েছে।',
