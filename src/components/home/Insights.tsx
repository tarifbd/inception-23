...
const articles = [
  {
    category: 'Strategy',
    title: 'Rethinking Corporate Velocity in a Stagnant Market.',
    date: 'OCT 2026',
    read: '7 min',
    ...
    <section id="insights" className="relative overflow-hidden border-t border-gray-200 bg-[#f6f7fb] py-24 dark:border-white/10 dark:bg-night-950 md:py-36">
      ...
      <div className="container relative z-10 mx-auto max-w-7xl px-6">
        <div className="mb-12 grid gap-8 lg:grid-cols-[1fr_0.6fr] lg:items-end">
          <div>
            ...
            <h2 className="max-w-4xl font-serif text-[clamp(2.6rem,5vw,4.75rem)] font-black leading-[1.03] tracking-tight text-brand-950 dark:text-white">
              <SplitText text={lang === 'en' ? 'Intelligence for operators.' : 'পরিচালকদের জন্য অন্তর্দৃষ্টি।'} />
            </h2>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            <Image src={featured.img} alt={featured.title} fill className="object-cover transition duration-1000 group-hover:scale-105" />
            ...
            {sideArticles.map((article, index) => (
              ...
              >
                <div className="relative min-h-[260px] sm:min-h-full">
                  <Image src={article.img} alt={article.title} fill className="object-cover transition duration-700 group-hover:scale-105" />
