                ...
                >
                  ...
                  <div className="relative bg-white dark:bg-night-900 rounded-[31px] overflow-hidden h-full flex flex-col justify-between p-6 md:p-8">
                    ...
                    <div className="flex justify-between items-start mb-6 relative z-10">
                      ...
                      <span className="flex h-10 w-10 items-center justify-center rounded-full border border-gray-150 bg-gray-50 text-[10px] font-black dark:border-white/10 dark:bg-white/5 font-mono">
                        {member.metric}
                      </span>
                    </div>
                    ...
                    <div className={`flex flex-col ${isFounder ? 'sm:flex-row' : ''} gap-6 items-center flex-grow mb-6 relative z-10 text-left`}>
                      ...
                      <div className={`relative w-28 h-28 ${isFounder ? 'sm:w-36 sm:h-36' : 'w-32 h-32'} rounded-2xl overflow-hidden shrink-0 border border-gray-150 dark:border-white/10 bg-night-950 shadow-sm`}>
                        <Image 
                          src={member.img} 
                          alt={member.name} 
                          fill 
                    ...
                    {/* Bottom Link CTA */}
                    <div className="border-t border-gray-100 dark:border-white/5 pt-4 flex justify-between items-center text-[10px] font-black uppercase tracking-widest text-brand-950 dark:text-white relative z-10 group-hover:text-brand-750 dark:group-hover:text-brand-400 transition-all">
      ...
      <AnimatePresence>
        {selectedMember && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className="p-6 border-b border-gray-150 dark:border-white/5 flex justify-between items-center bg-gray-50/50 dark:bg-night-900/50">
              ...
              <div className="overflow-y-auto no-scrollbar p-6 flex-grow space-y-6">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600 dark:text-gray-355 text-sm font-light leading-relaxed">
                ...
                {/* Full biography card */}
                <div className="p-5 rounded-2xl bg-gray-50 dark:bg-white/[0.02] border border-gray-150 dark:border-white/5 space-y-3 text-left">
                ...
                <div className="space-y-3 text-left">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                    {['Strategic Restructuring', 'Operational Optimization', 'Regulatory Alignment', 'Digital Architecture'].map((item, index) => (
                      <div key={index} className="flex items-center gap-2 text-xs text-gray-550 dark:text-gray-350">
              ...
              {/* Bottom CTAs */}
              <div className="p-6 border-t border-gray-150 dark:border-white/5 bg-gray-50/50 dark:bg-night-900/50 flex gap-4">
                <Magnetic>
                  <a 
