...
const processAccentStyles = [
  {
    card: 'border-cyan-200/80 bg-white dark:border-cyan-300/20 dark:bg-[#0d1724]',
  ...
  {
    card: 'border-emerald-200/80 bg-white dark:border-emerald-300/20 dark:bg-[#0d1b21]',
  ...
  {
    card: 'border-violet-200/80 bg-white dark:border-violet-300/20 dark:bg-[#151728]',
  ...
  {
    card: 'border-orange-200/80 bg-white dark:border-orange-300/20 dark:bg-[#211522]',
      ...
      <div className="space-y-5">
        {displaySteps.map((step, index) => {
          ...
          return (
            ...
            >
              <article className={`group relative ml-12 overflow-hidden rounded-lg border p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md md:ml-0 ${accent.card}`}>
