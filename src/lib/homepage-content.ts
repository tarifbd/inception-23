...
export const defaultHomepageContent: HomepageContent = {
  ...
  sections: [
    ...
    { key: 'mainServices', label: 'Main Services Showcase', enabled: true, order: 120, eyebrow: 'Main services', title: 'Strategic capability, delivered in color.', description: 'A scroll-triggered view of the four Inception 23 operating pillars: technology, management, legal support, and creative execution.' },
  ],
};
